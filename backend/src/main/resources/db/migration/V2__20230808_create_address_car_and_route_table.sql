...
VALUES ('Azoud', 'Mustafa', 'azoud@example.com', crypt('Mustafa@123', gen_salt('bf')), '1985-01-15', null, null, null,
        'ROLE_ADMIN'),
       ('Samiha', 'Draa', 'draa@example.com', crypt('Samiha@123', gen_salt('bf')), '1982-10-22', null, 4.2, 2,
        'ROLE_USER'),
       ...
       ('Pigeolet', 'Xavier', 'pigeolet@example.com', crypt('Xavier@123', gen_salt('bf')), '1991-09-08', null, 4.5, 4,
        'ROLE_USER'),
       ('Michel', 'Marc', 'michel@example.com', crypt('Marc@123', gen_salt('bf')), '1988-04-18', null, 4.5, 5,
        'ROLE_USER'),
       ('Depaepe', 'Jean-Michel', 'depaepe@example.com', crypt('Jeanmichel@123', gen_salt('bf')), '1978-12-30', null,
        4.9, 8,
        'ROLE_USER'),
...
VALUES ('Rue de la Loi 16, 1000 Bruxelles', 'Aéroport de Bruxelles', '2023-11-15', '10:00', 3, 2, 20,
       ...
       ('Chaussée de Waterloo 100, 1050 Bruxelles', 'Gare du nord, 1000 Bruxelles', '2023-11-15', '06:00', 2, 3, 15.0,
        ST_SetSRID(ST_MakePoint(4.3449674, 50.8291325), 4326), ST_SetSRID(ST_MakePoint(4.3608795, 50.8603166), 4326)),
       ('Avenue Louise 123, 1000 Bruxelles', 'Aéroport de Bruxelles', '2023-11-15', '16:30', 1, 5, 10.0,
