...
VALUES ('Rue de la Loi 16, 1000 Bruxelles', 'Aéroport de Bruxelles', '2023-11-15','10:00', 1, 2, 20,
       ...
       ('Avenue des Arts 10, 1210 Bruxelles', 'Aéroport de charleroi', '2023-11-20','19:45', 4, 9, 25.0,
       ...
       ('Chaussée de Waterloo 100, 1050 Bruxelles', 'Gare du nord, 1000 Bruxelles', '2023-11-15','06:00', 1, 3, 15.0,
        ST_SetSRID(ST_MakePoint(4.3449674, 50.8291325), 4326), ST_SetSRID(ST_MakePoint(4.3608795, 50.8603166), 4326),'ACTIVE'),
       ...
       ('Avenue des Arts 10, 1210 Bruxelles', 'Boulevard Anspach 5, 1000 Bruxelles', '2023-11-15','15:15', 2, 4, 15.0,
        ST_SetSRID(ST_MakePoint(4.3698678, 50.8480114), 4326), ST_SetSRID(ST_MakePoint(4.3513328, 50.8503206), 4326),'ACTIVE'),
       ...
       ('Rue du Midi 20, 1000 Bruxelles', 'Gare de Tubize, 1480 Tubize', '2023-11-15','16:50', 3, 8, 20.0,
        ...
        ST_SetSRID(ST_MakePoint(4.20573, 50.69171), 4326),'ACTIVE'),
       ('Chaussée de Waterloo 100, 1060 Bruxelles', 'Plage Ostende, 8400 Oostende', '2023-08-15','09:00', 1, 9, 15.0,
        ST_SetSRID(ST_MakePoint(4.3449674, 50.8291325), 4326),
        ST_SetSRID(ST_MakePoint(2.9161003, 51.23530539999999), 4326),'ACTIVE'),
       ('Avenue Louise 123, 1050 Bruxelles', 'Hopital Brugmann, 1020 Bruxelles', '2023-08-20','09:25', 4, 5, 10.0,
       ...
       ('Rue de la Loi 16, 1000 Bruxelles', 'Otan, Bruxelles', '2023-11-21','17:10', 4, 9, 25.0,
        ST_SetSRID(ST_MakePoint(4.3663459, 50.8464734), 4326), ST_SetSRID(ST_MakePoint(4.4261565, 50.8791181), 4326),'ACTIVE'),
       ...
       ('Avenue des Arts 10, 1210 Bruxelles', 'Aéroport de Bruxelles', '2023-11-21','05:50', 2, 6, 15.0,
        ST_SetSRID(ST_MakePoint(4.3698678, 50.8480114), 4326),
        ST_SetSRID(ST_MakePoint(4.485941899999999, 50.9002379), 4326),'ACTIVE'),
